...
Update the comment block above these settings to describe the P2 4-panel serpentine layout.
...
# Expected: width 256, height 128, pixel_mapper U-mapper, rows 64, cols 128, chain 4, parallel 1
```
