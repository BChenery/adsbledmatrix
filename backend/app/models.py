...
class UserConfig(Base):
    ...
    # When idle: alternate between idle layout and World Weather (if available)
    idle_weather_enabled = Column(Boolean, nullable=False, default=True, server_default=text("1"))
    idle_rotation_interval_sec = Column(Integer, nullable=False, default=15, server_default=text("15"))
