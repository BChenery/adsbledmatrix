...
from scripts.validate_layouts import validate_layout
...
def test_custom_colour_passes():
    """Designer-customized colors are allowed in shipped layouts."""
    layout = {
        "name": "Colour",
        "width": 256,
        "height": 128,
...
def test_out_of_bounds_fails():
    ...
    assert any("outside canvas" in e for e in errors)
